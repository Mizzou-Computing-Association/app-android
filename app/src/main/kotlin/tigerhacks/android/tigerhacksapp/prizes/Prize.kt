...
data class PrizeList(
    ...
    fun combine(): List<Prize> {
        ...
        total.add(Prize(id="${HEADER_KEY}0", prizeType = "Sponsored"))
        total.addAll(Sponsored)
        total.add(Prize(id="${HEADER_KEY}1", prizeType = "StartUp"))
        total.addAll(StartUp)
        total.add(Prize(id="${HEADER_KEY}2", prizeType = "Visuals"))
        total.addAll(Visuals)
        total.add(Prize(id="${HEADER_KEY}3", prizeType = "Audio"))
        total.addAll(Audio)
        total.add(Prize(id="${HEADER_KEY}4", prizeType = "Hardware"))
